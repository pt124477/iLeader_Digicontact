...
import { Page, List, Icon, Modal, Swiper, Text, Box, Button, BottomNavigation, Sheet,useTheme } from "zmp-ui";
    ...
    <Page className="section-container">
      ...
      <Box mt={6}>
        ...
        <Text.Title className="text-detail">
          Chi nhánh trung tâm Quận 1 với 1000 học viên đã hoạt động trong vòng 10 năm với độ uy tích trên thị trường dạy tiếng anh ở Việt Nam. Còn trần trừ gì nữa mà không đăng ký cho con em mình học ở ngay trung tâm quận 1
        </Text.Title>
      </Box>
      <Box
        mt={6}
