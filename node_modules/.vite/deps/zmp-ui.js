import {
  ...
  useNavigate,
  useNavigationType
} from "./chunk-PH5PJEWH.js";
import {
  require_react_dom
} from "./chunk-ABPFXTTK.js";
import {
  require_react
} from "./chunk-NXZQ4ROK.js";
import {
  __commonJS,
  __toESM
...
// node_modules/zmp-ui/esm/components/app/props-type.js
var Theme;
(function(Theme2) {
  Theme2["dark"] = "dark";
  Theme2["light"] = "light";
...
var App = function App2(props) {
  var theme = props.theme, rest = _objectWithoutPropertiesLoose(props, _excluded);
  var _useState = (0, import_react2.useState)(theme || Theme.light), currentTheme = _useState[0], setCurrentTheme = _useState[1];
...
// node_modules/zmp-ui/esm/components/button/props-type.js
var ButtonType;
(function(ButtonType2) {
  ButtonType2["highlight"] = "highlight";
  ButtonType2["danger"] = "danger";
  ButtonType2["neutral"] = "neutral";
})(ButtonType || (ButtonType = {}));
var ButtonHTMLType;
(function(ButtonHTMLType2) {
  ButtonHTMLType2["submit"] = "submit";
  ButtonHTMLType2["button"] = "button";
  ButtonHTMLType2["reset"] = "reset";
...
(function(ButtonVariants2) {
  ButtonVariants2["primary"] = "primary";
  ButtonVariants2["secondary"] = "secondary";
  ButtonVariants2["tertiary"] = "tertiary";
...
var Button = import_react4.default.forwardRef(function(props, ref) {
  var _classNames;
  var children2 = props.children, prefixIcon = props.prefixIcon, suffixIcon = props.suffixIcon, icon2 = props.icon, fullWidth = props.fullWidth, loading = props.loading, disabled = props.disabled, type = props.type, size = props.size, className = props.className, _props$variant = props.variant, variant = _props$variant === void 0 ? ButtonVariants.primary : _props$variant, _props$htmlType = props.htmlType, htmlType = _props$htmlType === void 0 ? ButtonHTMLType.button : _props$htmlType, onClick = props.onClick, rest = _objectWithoutPropertiesLoose(props, _excluded2);
  var prefixCls = getPrefixCls("btn");
  var buttonRef = ref || import_react4.default.createRef();
  var cls = clsx_m_default(prefixCls, (_classNames = {}, _classNames[prefixCls + "-highlight"] = type === ButtonType.highlight, _classNames[prefixCls + "-danger"] = type === ButtonType.danger, _classNames[prefixCls + "-neutral"] = type === ButtonType.neutral, _classNames[prefixCls + "-primary"] = variant === ButtonVariants.primary, _classNames[prefixCls + "-secondary"] = variant === ButtonVariants.secondary, _classNames[prefixCls + "-tertiary"] = variant === ButtonVariants.tertiary, _classNames[prefixCls + "-disabled"] = disabled, _classNames[prefixCls + "-loading"] = loading && !disabled, _classNames[prefixCls + "-icon-only"] = icon2, _classNames[prefixCls + "-suffix-icon"] = suffixIcon, _classNames[prefixCls + "-prefix-icon"] = prefixIcon, _classNames[prefixCls + "-small"] = size === ButtonSize.small, _classNames[prefixCls + "-medium"] = size === ButtonSize.medium, _classNames[prefixCls + "-large"] = size === ButtonSize.large, _classNames[prefixCls + "-full-width"] = fullWidth, _classNames[prefixCls + "-prefix-icon"] = prefixIcon, _classNames[prefixCls + "-suffix-icon"] = suffixIcon, _classNames[prefixCls + "-icon-only"] = icon2, _classNames["" + className] = className, _classNames));
  ...
  var removePasswordTimeout = function removePasswordTimeout2() {
    removePasswordTimeoutRef.current.push(window.setTimeout(function() {
      ...
      if (inputRef.current && ((_inputRef$current = inputRef.current) == null ? void 0 : _inputRef$current.getAttribute("type")) === "password" && (_inputRef$current2 = inputRef.current) != null && _inputRef$current2.hasAttribute("value")) {
        ...
        (_inputRef$current3 = inputRef.current) == null ? void 0 : _inputRef$current3.removeAttribute("value");
      }
    }));
  };
  (0, import_react16.useImperativeHandle)(ref, function() {
    return {
      ...
      setSelectionRange: function setSelectionRange(start2, end, direction) {
        ...
        (_inputRef$current5 = inputRef.current) == null ? void 0 : _inputRef$current5.setSelectionRange(start2, end, direction);
      },
      select: function select() {
        var _inputRef$current6;
        (_inputRef$current6 = inputRef.current) == null ? void 0 : _inputRef$current6.select();
      },
...
var Search = import_react21.default.forwardRef(function(props, ref) {
  ...
  var onSearch = function onSearch2(e) {
    if (customOnSearch) {
      var _inputRef$current2, _inputRef$current2$in;
      customOnSearch(((_inputRef$current2 = inputRef.current) == null ? void 0 : (_inputRef$current2$in = _inputRef$current2.input) == null ? void 0 : _inputRef$current2$in.value) || "", e);
    }
  };
  ...
  var removePasswordTimeout = function removePasswordTimeout2() {
    removePasswordTimeoutRef.current.push(window.setTimeout(function() {
      ...
      if (textareaRef.current && ((_textareaRef$current = textareaRef.current) == null ? void 0 : _textareaRef$current.getAttribute("type")) === "password" && (_textareaRef$current2 = textareaRef.current) != null && _textareaRef$current2.hasAttribute("value")) {
        ...
        (_textareaRef$current3 = textareaRef.current) == null ? void 0 : _textareaRef$current3.removeAttribute("value");
      }
    }));
  };
  (0, import_react22.useImperativeHandle)(ref, function() {
    return {
      ...
      blur: function blur() {
        ...
        (_textareaRef$current4 = textareaRef.current) == null ? void 0 : _textareaRef$current4.blur();
      },
      setSelectionRange: function setSelectionRange(start2, end, direction) {
        var _textareaRef$current5;
        (_textareaRef$current5 = textareaRef.current) == null ? void 0 : _textareaRef$current5.setSelectionRange(start2, end, direction);
      },
      select: function select() {
        var _textareaRef$current6;
        (_textareaRef$current6 = textareaRef.current) == null ? void 0 : _textareaRef$current6.select();
      },
...
var StoryStatus;
(function(StoryStatus2) {
  StoryStatus2["seen"] = "seen";
  StoryStatus2["default"] = "default";
})(StoryStatus || (StoryStatus = {}));
var GradientVariants;
(function(GradientVariants2) {
  GradientVariants2["BLUE-BLUELIGHT"] = "BLUE-BLUELIGHT";
  GradientVariants2["PURPLE-BLUE"] = "PURPLE-BLUE";
  GradientVariants2["SKYBLUE-GREEN"] = "SKYBLUE-GREEN";
  GradientVariants2["GREEN-GREENLIGHT"] = "GREEN-GREENLIGHT";
...
var Page = import_react56.default.forwardRef(function(props, ref) {
  ...
  (0, import_react56.useLayoutEffect)(function() {
    ...
    if (page && routerContext && (restoreScroll || restoreScrollOnBack)) {
      ...
      page == null ? void 0 : page.addEventListener("scroll", onPageScroll);
    }
    ...
    return function() {
      if (page && routerContext && (restoreScroll || restoreScrollOnBack)) {
        page == null ? void 0 : page.removeEventListener("scroll", onPageScroll);
      }
    };
...
var AnimationRoutes = function AnimationRoutes2(props) {
  ...
  var moveTouch = function moveTouch2(e) {
    ...
    if (initialX.current <= 24 && Math.abs(diffX) > Math.abs(diffY) && diffX <= 0 && animate) {
      e.preventDefault();
      setAnimate == null ? void 0 : setAnimate({
        animate: false
      });
      e.preventDefault();
    }
...
var Checkbox = import_react64.default.forwardRef(function(props, ref) {
  ...
  }, import_react64.default.createElement(TickIcon_default, null)))), children2 ? import_react64.default.createElement("span", null, children2) : import_react64.default.createElement("span", null, label));
});
...
var Group3 = import_react65.default.forwardRef(function(props, ref) {
  ...
  var toggleOption = (0, import_react65.useCallback)(function(option) {
    ...
    var opts = getOptions();
    onChange == null ? void 0 : onChange(newValue.filter(function(val) {
...
var Radio = import_react67.default.forwardRef(function(props, ref) {
  ...
  var onChange = function onChange2(e) {
    ...
    groupContext == null ? void 0 : groupContext.onChange == null ? void 0 : groupContext.onChange(e);
  };
  if (groupContext) {
...
// node_modules/zmp-ui/esm/components/switch/props-type.js
var SwitchSize;
...
var Switch = import_react69.default.forwardRef(function(props, ref) {
  ...
  return import_react69.default.createElement(Wrapper, {
    ...
    ref,
    type: "checkbox",
    className: clsx_m_default(prefixCls, (_clsx = {}, _clsx[prefixCls + "-small"] = size === SwitchSize.small, _clsx), className)
  })), label && import_react69.default.createElement("div", {
    className: clsx_m_default(prefixCls + "-label", (_clsx2 = {}, _clsx2[prefixCls + "-label-small"] = size === SwitchSize.small, _clsx2))
  }, label));
});
  ...
  var handleChange = function handleChange2(_ref) {
    ...
    if (!Array.isArray(value)) {
      ...
      if (thumbIndex.current === 0) {
        ...
        setValue(cloneValue);
        onChange == null ? void 0 : onChange(cloneValue);
      }
    }
  };
...
var Portal = (0, import_react78.forwardRef)(function(props, ref) {
  ...
  (0, import_react78.useEffect)(function() {
    var _containerRef$current;
    if ((containerRef == null ? void 0 : (_containerRef$current = containerRef.current) == null ? void 0 : _containerRef$current.parentNode) === null && parentRef.current !== null) {
      var _parentRef$current;
      parentRef == null ? void 0 : (_parentRef$current = parentRef.current) == null ? void 0 : _parentRef$current.appendChild(containerRef.current);
    }
    return function() {
      var _containerRef$current2, _containerRef$current3;
      (_containerRef$current2 = containerRef.current) == null ? void 0 : (_containerRef$current3 = _containerRef$current2.parentNode) == null ? void 0 : _containerRef$current3.removeChild(containerRef.current);
    };
  }, []);
    ...
    function Trigger2(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "getComponent", function() {
        ...
        return import_react79.default.createElement(sheet_default2, _extends({
          ...
          afterClose: function afterClose() {
            ...
            onPopupVisibleChange == null ? void 0 : onPopupVisibleChange(false);
          },
          zIndex,
          handler: false,
      ...
      _defineProperty(_assertThisInitialized(_this), "handlePortalUpdate", function() {
        ...
        if (prevPopupVisible !== popupVisible) {
          afterPopupVisibleChange == null ? void 0 : afterPopupVisibleChange(popupVisible);
        }
      });
    ...
    _proto.setPopupVisible = function setPopupVisible(popupVisible) {
      ...
      if (prevPopupVisible !== popupVisible) {
        if (popupVisible) {
          ...
          onPopupVisibleChange == null ? void 0 : onPopupVisibleChange(popupVisible);
        } else {
          this.setState({
            sheetAnimationVisible: popupVisible,
            prevPopupVisible
...
var Select = import_react83.default.forwardRef(function(props, ref) {
  ...
  var getSelectedInputDisplay = function getSelectedInputDisplay2(val) {
    if (!Array.isArray(val)) {
      var _options$find, _options$find$label;
      return (_options$find = options.find(function(otp) {
        return otp.value === val;
      })) == null ? void 0 : (_options$find$label = _options$find.label) == null ? void 0 : _options$find$label.toString();
    }
  ...
  var updateValue = (0, import_react83.useCallback)(function(val) {
    if (Array.isArray(value) && multiple) {
      ...
      if (index2 !== -1) {
        ...
        onChange == null ? void 0 : onChange([].concat(newValue));
        setValue([].concat(newValue));
      } else {
        onChange == null ? void 0 : onChange([].concat(value, [val]));
  ...
  return import_react83.default.createElement(Context.Provider, {
    ...
    onVisibilityChange: function onVisibilityChange(v) {
      if (v !== visible) {
        setVisible(v);
        _onVisibilityChange == null ? void 0 : _onVisibilityChange(v);
      }
    }
...
var useSnackbar = function useSnackbar2() {
  ...
  var open = function open2(option) {
    openSnackbar == null ? void 0 : openSnackbar(option);
  };
  var close = function close2() {
    closeSnackbar == null ? void 0 : closeSnackbar();
  };
  var setDownload = function setDownload2(completed) {
    setDownloadProgress == null ? void 0 : setDownloadProgress(completed);
  };
  return {
    openSnackbar: open,
    closeSnackbar: close,
...
var PickerColumn = function PickerColumn2(props) {
  ...
  var onValueSelected = function onValueSelected2(opt, colName) {
    onChange == null ? void 0 : onChange(opt, colName);
  };
  ...
  var renderItems = function renderItems2() {
    ...
    return options.map(function(option, index2) {
      ...
      var itemCls = clsx_m_default(itemPrefixCls, (_classNames = {}, _classNames[itemPrefixCls + "-selected"] = !state.isMoving && index2 === selectedIndex, _classNames[itemPrefixCls + "-2nd"] = !state.isMoving && (index2 === selectedIndex - 1 || index2 === selectedIndex + 1), _classNames));
...
var PickerPanel = function PickerPanel2(props) {
  ...
  var closeModal = function closeModal2(event) {
    closePanel == null ? void 0 : closePanel(event);
  };
...
var Picker = function Picker2(props) {
      ...
      Object.keys(opts).forEach(function(optName) {
        ...
        if (group) {
          ...
          if (opt) {
            ...
            updateDatePickerData == null ? void 0 : updateDatePickerData();
          }
        }
      });
      return result;
  ...
  var handleChangePickerValue = function handleChangePickerValue2(otp, name) {
    ...
    if (!value) {
      onChange == null ? void 0 : onChange(pickerValue);
    } else {
      var different = false;
      Object.entries(value).forEach(function(_ref) {
        var _pickerValue$k;
        var k = _ref[0], v = _ref[1];
        if (((_pickerValue$k = pickerValue[k]) == null ? void 0 : _pickerValue$k.value) !== v) {
          different = true;
        }
      });
      if (different) {
...
// node_modules/zmp-ui/esm/components/date-picker/props-type.js
var ColumnFormat;
(function(ColumnFormat2) {
  ColumnFormat2["MM-DD-YYYY"] = "MM-DD-YYYY";
  ColumnFormat2["DD-MM-YYYY"] = "DD-MM-YYYY";
  ColumnFormat2["YYYY-MM-DD"] = "YYYY-MM-DD";
...
var createPickerColumns = function createPickerColumns2(date, config2) {
  ...
  if (config2.datePickerColumns && typeof config2.datePickerColumns === "string" && Object.keys(ColumnFormat).map(function(k2) {
    return k2;
...
var DatePicker = function DatePicker2(props) {
  ...
  var updateData = function updateData2(curDate, curMonth, curYear, fireOnChange) {
    ...
    if (fireOnChange) {
      var _onChange;
      onChange == null ? void 0 : onChange(new Date(currentYear, currentMonth - 1, currentDate, 0, 0, 0), (_onChange = {}, _onChange[YEAR_COL_NAME] = currentYear.toString(), _onChange[MONTH_COL_NAME] = currentMonth.toString(), _onChange[DATE_COL_NAME] = currentDate.toString(), _onChange));
    }
  };
...
var AnimatedBottomNavigationItem = import_react100.default.forwardRef(function(props, ref) {
  ...
  var handleClick = function handleClick2(e) {
    if (onClick) {
      ...
      navigate == null ? void 0 : navigate(linkTo, {
        animate: true,
        direction
      });
    }
  ...
  var runSprings = (0, import_react106.useCallback)(function(_vx, isDragging, mx, offset) {
    ...
    set({
      ...
      onRest: function onRest() {
        ...
        if (!loop2) {
          afterChange == null ? void 0 : afterChange(activeIndex);
          return;
        }
        if (index2.current === 0) {
        ...
        afterChange == null ? void 0 : afterChange(activeIndex - 1);
      }
    });
