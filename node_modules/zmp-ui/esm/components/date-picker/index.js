...
var DatePicker = function DatePicker(props) {
  ...
  var prefixCls = getPrefixCls("date-picker"); // Concat base class name and user class name
  ...
  var initDateValue = convertDateToPickerValue(new Date()); // Convert user default value to picker value

  var defaultDateValue = defaultValue ? convertDateToPickerValue(defaultValue) : undefined; // Convert value passed in from props to picker value
