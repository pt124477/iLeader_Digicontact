...
var TextArea = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var contextStatus = "";
  var mergedStatus = (0, _statusUtils.getMergedStatus)(contextStatus, customStatus); // ===================== Remove Password value =====================
  ...
  (0, _react.useImperativeHandle)(ref, function () {
    return {
      ...
      setSelectionRange: function setSelectionRange(start, end, direction) {
        ...
        (_textareaRef$current5 = textareaRef.current) == null ? void 0 : _textareaRef$current5.setSelectionRange(start, end, direction);
      },
  ...
  var getInputElement = function getInputElement() {
    ...
    var otherProps = (0, _omit.default)(props, ["onPressEnter", "prefix", "suffix", "clearable", "status", "helperText", "errorText", "size", // Input elements must be either controlled or uncontrolled,
