...
var BaseInput = function BaseInput(props) {
  ...
  var onInputMouseDown = function onInputMouseDown(e) {
    ...
    if ((_containerRef$current = containerRef.current) != null && _containerRef$current.contains(e.target)) {
      triggerFocus == null ? void 0 : triggerFocus();
    }
  }; // ================== Clear Icon ================== //
  ...
  if ((0, _commonUtils.hasAddon)(props)) {
    ...
    var mergedGroupClassName = (0, _clsx.default)(prefixCls + "-group-wrapper", className, groupClassName); // Need another wrapper for changing display:table to display:inline-block
