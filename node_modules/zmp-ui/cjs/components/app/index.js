...
var App = function App(props) {
  ...
  var _useState = (0, _react.useState)(theme || _propsType.Theme.light),
      currentTheme = _useState[0],
      setCurrentTheme = _useState[1];

  (0, _react.useEffect)(function () {
    if (currentTheme === _propsType.Theme.dark || currentTheme === _propsType.Theme.light) {
  ...
  var switcher = (0, _react.useCallback)(function (_ref) {
    ...
    if (mode === _propsType.Theme.dark || mode === _propsType.Theme.light) {
