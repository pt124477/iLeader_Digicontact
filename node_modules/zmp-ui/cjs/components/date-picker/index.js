...
var DatePicker = function DatePicker(props) {
  ...
  var prefixCls = (0, _class.getPrefixCls)("date-picker"); // Concat base class name and user class name
  ...
  var _useState2 = (0, _react.useState)(),
      ...
      setDateValue = _useState2[1]; // Set today as default value


  var initDateValue = (0, _utils.convertDateToPickerValue)(new Date()); // Convert user default value to picker value

  var defaultDateValue = defaultValue ? (0, _utils.convertDateToPickerValue)(defaultValue) : undefined; // Convert value passed in from props to picker value
  ...
  var updateData = function updateData(curDate, curMonth, curYear, fireOnChange) {
    ...
    if (fireOnChange) {
      ...
      onChange == null ? void 0 : onChange(new Date(currentYear, currentMonth - 1, currentDate, 0, 0, 0), (_onChange = {}, _onChange[_constants.YEAR_COL_NAME] = currentYear.toString(), _onChange[_constants.MONTH_COL_NAME] = currentMonth.toString(), _onChange[_constants.DATE_COL_NAME] = currentDate.toString(), _onChange));
    }
