 ...
 */
var getMonthlyDay = function getMonthlyDay(year, month) {
  var day = 31;
...
exports.getMonthlyDay = getMonthlyDay;

var dayFormatter = function dayFormatter(locale) {
...
var monthFormatter = function monthFormatter(locale) {
  return new Intl.DateTimeFormat(locale, {
    month: "long"
  });
};

exports.monthFormatter = monthFormatter;

var shortMonthFormatter = function shortMonthFormatter(locale) {
  return new Intl.DateTimeFormat(locale, {
    month: "short"
  });
};

exports.shortMonthFormatter = shortMonthFormatter;

var yearFormatter = function yearFormatter(locale) {
  return new Intl.DateTimeFormat(locale, {
    year: "numeric"
  });
};
...
exports.yearFormatter = yearFormatter;

var getDateRange = function getDateRange(startDate, endDate) {
  var result = {
...
var convertDateToPickerValue = function convertDateToPickerValue(date) {
  var _ref2;
...
exports.convertDateToPickerValue = convertDateToPickerValue;
...
var formatDate = function formatDate(d, config) {
  if (config === void 0) {
    config = {};
  }
...
var createPickerColumns = function createPickerColumns(date, config) {
  if (config === void 0) {
    config = {};
  }
  ...
  if (config.datePickerColumns && typeof config.datePickerColumns === "string" && Object.keys(_propsType.ColumnFormat).map(function (k) {
    return k;
...
exports.createPickerColumns = createPickerColumns;