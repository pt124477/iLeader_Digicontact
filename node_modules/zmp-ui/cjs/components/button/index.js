...
var Button = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  var children = props.children,
      ...
      variant = _props$variant === void 0 ? _propsType.ButtonVariants.primary : _props$variant,
      _props$htmlType = props.htmlType,
      htmlType = _props$htmlType === void 0 ? _propsType.ButtonHTMLType.button : _props$htmlType,
  ...
  var cls = (0, _clsx.default)(prefixCls, (_classNames = {}, _classNames[prefixCls + "-highlight"] = type === _propsType.ButtonType.highlight, _classNames[prefixCls + "-danger"] = type === _propsType.ButtonType.danger, _classNames[prefixCls + "-neutral"] = type === _propsType.ButtonType.neutral, _classNames[prefixCls + "-primary"] = variant === _propsType.ButtonVariants.primary, _classNames[prefixCls + "-secondary"] = variant === _propsType.ButtonVariants.secondary, _classNames[prefixCls + "-tertiary"] = variant === _propsType.ButtonVariants.tertiary, _classNames[prefixCls + "-disabled"] = disabled, _classNames[prefixCls + "-loading"] = loading && !disabled, _classNames[prefixCls + "-icon-only"] = icon, _classNames[prefixCls + "-suffix-icon"] = suffixIcon, _classNames[prefixCls + "-prefix-icon"] = prefixIcon, _classNames[prefixCls + "-small"] = size === _propsType.ButtonSize.small, _classNames[prefixCls + "-medium"] = size === _propsType.ButtonSize.medium, _classNames[prefixCls + "-large"] = size === _propsType.ButtonSize.large, _classNames[prefixCls + "-full-width"] = fullWidth, _classNames[prefixCls + "-prefix-icon"] = prefixIcon, _classNames[prefixCls + "-suffix-icon"] = suffixIcon, _classNames[prefixCls + "-icon-only"] = icon, _classNames["" + className] = className, _classNames));
