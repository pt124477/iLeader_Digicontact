...
var PickerPanel = function PickerPanel(props) {
  var className = props.className,
      ...
      title = props.title,
      initData = props.initData; // Merge classes
  ...
  var renderInner = function renderInner() {
    var innerPrefixCls = prefixCls + "-inner"; // Map the data array to the picker columns
...
var _default = /*#__PURE__*/_react.default.memo(PickerPanel);
