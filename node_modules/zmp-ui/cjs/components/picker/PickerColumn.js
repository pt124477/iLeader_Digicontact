...
var PickerColumn = function PickerColumn(props) {
  ...
  var prevSelected = (0, _react.useRef)(); // State of touch
  ...
  var computeTranslate = function computeTranslate() {
    ...
    var selectedIndex = initVal ? options.map(function (opt) {
      return opt.value;
    }).indexOf(initVal.value) : 0; // If the value is not in the options, select the first option
    ...
    if (datePickerColumn && (value == null ? void 0 : value.value) === prevSelected.current && selectedIndex <= 0 && prevSelected.current) {
      ...
      var lastValue = parseInt(options[options.length - 1].value.toString(), 10); // When the number of days in the month is less than the previous value,
  ...
  var renderItems = function renderItems() {
    ...
    return options.map(function (option, index) {
      ...
      var itemCls = (0, _clsx.default)(itemPrefixCls, (_classNames = {}, _classNames[itemPrefixCls + "-selected"] = !state.isMoving && index === selectedIndex, _classNames[itemPrefixCls + "-2nd"] = !state.isMoving && (index === selectedIndex - 1 || index === selectedIndex + 1), _classNames));
...
var _default = /*#__PURE__*/_react.default.memo(PickerColumn);
